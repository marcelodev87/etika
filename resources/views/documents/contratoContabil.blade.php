        ...
        @if($request->isMethod('post'))
            @php
                ...
                if(count($post) == 1){
                    ...
                    $naturalidade_presidente = $post[1]['naturalidade'];
                ...
                <div class="chart-box">
                    <div class="right_col" role="main">
                        ...
                        <div align=justify style='background-color:#FFFFFF;  padding: 25px 50px 25px 50px;'>
                            ...
                            <p><strong>§ 3º -</strong> A remessa de documentos entre as partes será enviada por email.
                            </p>
