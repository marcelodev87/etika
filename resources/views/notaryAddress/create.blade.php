                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone_1" id="input-phone-1" class="form-control phone" value="{{ old('phone_1') }}">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="form-group">
                                <label for="input-phone-2">Telefone 2</label>
                                <input type="text" name="phone_2" id="input-phone-2" class="form-control phone" value="{{ old('phone_2') }}">
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
                            <div class="form-group">
                                <label for="input-phone-3">Telefone 3</label>
                                <input type="text" name="phone_3" id="input-phone-3" class="form-control phone" value="{{ old('phone_3') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="textarea-obs1" name="observation_1">{{ old('observation_1') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="textarea-obs2" name="observation_2">{{ old('observation_2') }}</textarea>
                            </div>
                        </div>
